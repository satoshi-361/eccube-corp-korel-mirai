...
use Customize\Entity\BrowsedProduct;
use Customize\Repository\BrowsedProductRepository;
...
class MypageController extends AbstractController
{
    ...
    /**
     * @var BrowsedProductRepository
     */
    protected $browsedProductRepository;
     ...
     * @param BrowsedProductRepository $browsedProductRepository
    ...
    public function __construct(
        ...
        BrowsedProductRepository $browsedProductRepository,
        ...
        $this->browsedProductRepository = $browsedProductRepository;
     ...
     * 閲覧履歴画面.
     *
     * @Route("/mypage/browse-history", name="mypage_browse_history", methods={"GET", "POST"})
     * @Template("Mypage/browse_history.twig")
     */
    public function browseHistory(Request $request, PaginatorInterface $paginator)
    {
        $Customer = $this->getUser();
        $qb = $this->browsedProductRepository->createQueryBuilder('bp');

        $qb
            ->where('bp.Customer = :Customer')
