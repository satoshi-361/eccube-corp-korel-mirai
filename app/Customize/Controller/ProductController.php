...
class ProductController extends AbstractController
{
    ...
    public function detail(Request $request, Product $Product)
    {
        ...
        if ($this->isGranted('ROLE_USER')) {
            ...
            if ( empty($qb->getQuery()->getResult()) ) {
                ...
                $BrowsedProduct->setProduct($Product);
                $BrowsedProduct->setCustomer($Customer);

                $this->entityManager->persist($BrowsedProduct);
    ...
    public function addFavorite(Request $request, Product $Product)
    {
        ...
        if ($this->isGranted('ROLE_USER')) {
            ...
            if ( $request->request->has('path') && $request->request->get('path') == 'mypage' ) {
                // マイページで追加した場合
