...
use Eccube\Form\Type\Shopping\OrderType as BaseType;
...
class OrderType extends BaseType
{
    ...
    public function __construct(
        ...
        parent::__construct( $orderRepository, $deliveryRepository, $paymentRepository, $baseInfoRepository, $requestContext );
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('credit', CreditCardForTokenPaymentType::class, [
            'required' => true,
