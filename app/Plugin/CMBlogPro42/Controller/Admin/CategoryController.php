...
use Plugin\CMBlogPro42\Form\Type\Admin\CategoryType;
use Plugin\CMBlogPro42\Form\Type\Admin\SearchCategoryType;
...
class CategoryController extends AbstractController
{
     ...
     * @Template("@CMBlogPro42/admin/category/index.twig")
     */
     ...
     * @Template("@CMBlogPro42/admin/category/create.twig")
     */
     ...
     * @Template("@CMBlogPro42/admin/category/edit.twig")
     */
    ...
    /**
     * @Route("/%eccube_admin_route%/cm_blog/category/{id}/delete", name="cm_blog_admin_cat_delete", methods={"DELETE"})
     */
