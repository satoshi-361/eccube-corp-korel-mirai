...
namespace Plugin\OrderBySale42\Controller\Admin;

use Eccube\Controller\AbstractController;
use Eccube\Repository\Master\ProductListOrderByRepository;
use Plugin\OrderBySale42\Form\Type\Admin\ConfigType;
...
class ConfigController extends AbstractController
{
    ...
    /**
     * @Route("/%eccube_admin_route%/order_by_sale4/config", name="order_by_sale42_admin_config")
     * @Template("@OrderBySale42/admin/config.twig")
     */
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('order_by_sale42_admin_config');
        }
