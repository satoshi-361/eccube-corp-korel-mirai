...
class PluginManager extends AbstractPluginManager
{
    ...
    private function createMasterData(ContainerInterface $container)
    {
        ...
        $Configs = $entityManager->getRepository('Plugin\OrderBySale42\Entity\Config')->findAll();
        ...
        foreach ($data as $row) {
            ...
            if (!$Entity) {
                ...
                $Config = $entityManager->getRepository('Plugin\OrderBySale42\Entity\Config')->get();
                if (!$Config) {
                    $Config = new Config();
                }
