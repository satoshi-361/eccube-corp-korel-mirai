...
namespace Plugin\PayPalCheckout42\Controller\ShortcutPaypalCheckout\Guest;

use Eccube\Entity\Customer;
use Eccube\Entity\Order;
use Eccube\Service\PurchaseFlow\PurchaseFlow;
use Exception;
use Plugin\PayPalCheckout42\Controller\ShortcutPaypalCheckout\ShortcutPayPalCheckoutController;
use Plugin\PayPalCheckout42\Exception\NotFoundCartException;
use Plugin\PayPalCheckout42\Exception\NotFoundOrderingIdException;
use Plugin\PayPalCheckout42\Exception\OrderInitializationException;
 ...
 * @package Plugin\PayPalCheckout42\Controller\ShortcutPaypalCheckout\Guest
 */
class UpdateShippingOrderController extends ShortcutPayPalCheckoutController
{
    /**
     * お届け先情報を PayPal から送信された情報で上書きする場合に、「ご注文内容確認」ページの間に呼ばれる
     *
     * @Method("POST")
