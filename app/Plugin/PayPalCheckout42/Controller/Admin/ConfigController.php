...
namespace Plugin\PayPalCheckout42\Controller\Admin;

use Eccube\Controller\AbstractController;
use Plugin\PayPalCheckout42\Entity\Config;
use Plugin\PayPalCheckout42\Entity\PluginSetting;
use Plugin\PayPalCheckout42\Service\PayPalPCPService;
use Plugin\PayPalCheckout42\Exception\PayPalCheckoutException;
use Plugin\PayPalCheckout42\Form\Type\Admin\ConfigType;
 ...
 * @package Plugin\PayPalCheckout42\Controller\Admin
 */
class ConfigController extends AbstractController
{
    ...
    /**
     * @Method("GET")
     * @Route("/%eccube_admin_route%/paypal/config", name="pay_pal_checkout42_admin_config")
     * @Template("@PayPalCheckout42/admin/config.twig")
     *
...
//            throw new BadRequestHttpException("ISU has been failed", $e, $e->getCode());
    ...
    /**
     * @Method("POST")
     * @Route("/%eccube_admin_route%/paypal/config", name="pay_pal_checkout42_admin_config_submit")
     *
     * @param Request $request
    ...
    public function post(Request $request)
    {
        ...
        return $this->redirectToRoute('pay_pal_checkout42_admin_config');
    }

    /**
     * @Method("POST")
     * @Route("/%eccube_admin_route%/paypal/config/login", name="pay_pal_checkout42_admin_login")
     *
     * @param Request $request
     * @return JsonResponse
     */
