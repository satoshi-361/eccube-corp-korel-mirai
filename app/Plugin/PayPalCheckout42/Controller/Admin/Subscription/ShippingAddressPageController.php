...
use Plugin\PayPalCheckout42\Entity\PrimaryShippingAddress;
use Plugin\PayPalCheckout42\Entity\SubscribingCustomer;
use Plugin\PayPalCheckout42\Exception\PayPalCheckoutException;
use Plugin\PayPalCheckout42\Form\Type\Admin\Subscription\SubscribingCustomerAddressType;
...
class ShippingAddressPageController extends AbstractController
{
     ...
     * @Template("@PayPalCheckout42/admin/shipping_address.twig")
     *
    ...
    public function post(Request $request, SubscribingCustomer $SubscribingCustomer)
    {
        ...
        switch (true) {
            ...
            case $form->isSubmitted() && !$form->isValid():
                ...
                return $this->render('@PayPalCheckout42/admin/shipping_address.twig', [
                    'SubscribingCustomer' => $SubscribingCustomer,
                    'form' => $form->createView(),
                ]);
            default:
