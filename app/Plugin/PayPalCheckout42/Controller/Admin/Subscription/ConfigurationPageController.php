...
use Plugin\PayPalCheckout42\Entity\ConfigSubscription;
use Plugin\PayPalCheckout42\Entity\SubscribingCustomer;
use Plugin\PayPalCheckout42\Exception\PayPalCheckoutException;
use Plugin\PayPalCheckout42\Form\Type\Admin\Subscription\ConfigSubscriptionType;
...
class ConfigurationPageController extends AbstractController
{
     ...
     * @Template("@PayPalCheckout42/admin/subscription_configure.twig")
     *
    ...
    public function post(Request $request, SubscribingCustomer $SubscribingCustomer)
    {
        ...
        switch (true) {
            ...
            case $form->isSubmitted() && !$form->isValid():
                ...
                return $this->render('@PayPalCheckout42/admin/subscription_configure.twig', [
                    'SubscribingCustomer' => $SubscribingCustomer,
                    'form' => $form->createView(),
                ]);
            default:
