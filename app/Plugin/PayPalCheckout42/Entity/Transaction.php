 ...
 * @ORM\Entity(repositoryClass="Plugin\PayPalCheckout42\Repository\TransactionRepository")
 */
class Transaction
{
    /**
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="Plugin\PayPalCheckout42\Entity\SubscribingCustomer", mappedBy="Transaction", cascade={"persist", "remove"})
     */
