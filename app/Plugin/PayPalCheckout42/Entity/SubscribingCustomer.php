 ...
 * @ORM\Entity(repositoryClass="Plugin\PayPalCheckout42\Repository\SubscribingCustomerRepository")
 */
class SubscribingCustomer
{
    /**
    ...
    /**
     * @ORM\Column(name="primary_shipping_address", type="json", length=2048, nullable=true)
     */
