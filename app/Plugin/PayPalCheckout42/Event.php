...
use Plugin\PayPalCheckout42\Service\PayPalAcdcService;
use Plugin\PayPalCheckout42\Service\PayPalOrderService;
use Plugin\PayPalCheckout42\Service\PayPalService;
use Plugin\PayPalCheckout42\Service\LoginService;
...
class Event implements EventSubscriberInterface
{
    ...
    public function onDefaultShoppingLoginTwig(TemplateEvent $event): void
    {
        ...
        $event->addAsset('@PayPalCheckout42/default/head.twig');
...
//        $this->session->remove(OrderHelper::SESSION_NON_MEMBER_ADDRESSES);
    ...
    public function onDefaultShoppingIndexTwig(TemplateEvent $event): void
    {
        ...
        if ($payment->getMethodClass() === InlineGuest::class) {
            ...
            $event->addSnippet('@PayPalCheckout42/default/Shopping/index/inline_guest.twig');
        ...
        if ($payment->getMethodClass() === Acdc::class) {
            ...
            $event->addSnippet('@PayPalCheckout42/default/Shopping/index/acdc.twig');
    ...
    public function onDefaultShoppingConfirmTwig(TemplateEvent $event): void
    {
        ...
        try {
            if ($isProcessingShortcutPayment) {
                ...
                $snippet = '@PayPalCheckout42/default/Shopping/confirm/shortcut.twig';
            } else if ($payment->getMethodClass() === InlineGuest::class) {
                $snippet = '@PayPalCheckout42/default/Shopping/confirm/inline_guest.twig';
            } else {
