...
use Plugin\EccubePaymentLite42\Repository\DeliveryCompanyRepository;
use Plugin\EccubePaymentLite42\Repository\GmoEpsilonPaymentRepository;
use Plugin\EccubePaymentLite42\Repository\MyPageRegularSettingRepository;
...
class PluginManager extends AbstractPluginManager
{
    ...
    private function getPageData()
    {
        return [
            [
                'name' => 'イプシロン決済プラグイン マイページ/カード編集',
                'url' => 'eccube_payment_lite42_mypage_credit_card_index',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/edit_credit_card',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン トークン決済クレジットカード入力',
                'url' => 'eccube_payment_lite42_credit_card_for_token_payment',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Shopping/credit_card_for_token_payment',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期受注編集完了',
                'url' => 'eccube_payment_lite42_mypage_regular_complete',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_complete',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期受注解約',
                'url' => 'eccube_payment_lite42_mypage_regular_suspend',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_suspend',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期受注休止',
                'url' => 'eccube_payment_lite42_mypage_regular_cancel',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_cancel',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期受注再開',
                'url' => 'eccube_payment_lite42_mypage_regular_resume',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_resume',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期サイクル変更',
                'url' => 'eccube_payment_lite42_mypage_regular_cycle',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_cycle',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/お届け予定日変更',
                'url' => 'eccube_payment_lite42_mypage_regular_next_delivery_date',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_next_delivery_date',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/お届け商品数変更',
                'url' => 'eccube_payment_lite42_mypage_regular_product_quantity',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_product_quantity',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期受注スキップ',
                'url' => 'eccube_payment_lite42_mypage_regular_skip',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_skip',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期お届け先変更',
                'url' => 'eccube_payment_lite42_mypage_regular_shipping',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_shipping',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期一覧',
                'url' => 'eccube_payment_lite42_mypage_regular_list',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_list',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
            [
                'name' => 'イプシロン決済プラグイン マイページ/定期購入詳細',
                'url' => 'eccube_payment_lite42_mypage_regular_detail',
                'file_name' => 'EccubePaymentLite42/Resource/template/default/Mypage/regular_detail',
                'edit_type' => Page::EDIT_TYPE_DEFAULT,
                'meta_robots' => 'noindex',
            ],
        ];
    ...
    {
        return [
            [GmoEpsilonPayment::CREDIT, 'クレジットカード決済', 1, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Credit'],
            [GmoEpsilonPayment::REGISTERED_CREDIT_CARD, '登録済みのクレジットカードで決済', 2, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Reg_Credit'],
            [GmoEpsilonPayment::CONVENIENCE_STORE, 'コンビニ決済', 3, 0.00, 299999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Conveni'],
            [GmoEpsilonPayment::ONLINE_BANK_JAPAN_NET_BANK, 'ネット銀行決済(PayPay銀行)', 4, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Netbank_Jnb'],
            [GmoEpsilonPayment::ONLINE_BANK_RAKUTEN, 'ネット銀行決済(楽天銀行)', 5, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Netbank_Rakuten'],
            [GmoEpsilonPayment::PAY_EASY, 'ペイジー決済', 6, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Payeasy'],
            [GmoEpsilonPayment::WEB_MONEY, 'WebMoney決済', 7, 0.00, 199999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Webmoney'],
            [GmoEpsilonPayment::YAHOO_WALLET, 'Yahoo!ウォレット決済サービス', 8, 0.00, 499999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Ywallet'],
            [GmoEpsilonPayment::PAYPAL, 'Paypal決済', 9, 0.00, 499999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Paypal'],
            [GmoEpsilonPayment::BIT_CASH, 'Bitcash決済', 10, 0.00, 199999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Bitcash'],
            [GmoEpsilonPayment::CHOCOM_E_MONEY, '電子マネーちょコム決済', 11, 0.00, 99999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Chocom'],
            [GmoEpsilonPayment::SMARTPHONE_CARRIER, 'スマートフォンキャリア決済', 12, 0.00, 50000, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Sphone'],
            [GmoEpsilonPayment::JCB_PREMO, 'JCB PREMO', 13, 0.00, 500000, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Jcb'],
            [GmoEpsilonPayment::ONLINE_BANK_SUMISHIN_SBI, '住信SBIネット銀行決済', 14, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Sumishin'],
            [GmoEpsilonPayment::GMO_DEFERRED_PAYMENT, 'GMO後払い', 15, 0.00, 49999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Deferred'],
            [GmoEpsilonPayment::VIRTUAL_ACCOUNT, 'バーチャル口座', 16, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Virtual_Account'],
            [GmoEpsilonPayment::PAYPAY, 'Paypay', 17, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Paypay'],
            [GmoEpsilonPayment::MAIL_LINK, 'メールリンク決済', 18, 0.00, 9999999, 1, 'Plugin\\EccubePaymentLite42\\Service\\Method\\Maillink'],
        ];
    }
    ...
    private function mailTemplateData()
    {
        return [
            ...
            [
                '定期指定回数お知らせメール',
                'EccubePaymentLite42/Resource/template/default/Mail/specified_count_notice_mail.twig',
                '定期購入商品継続のお礼',
            ],
        ];
    }
