...
use Plugin\EccubePaymentLite42\Service\GetNextDeliveryDateWhenResumingService;
...
class RegularResumeController extends AbstractController
{
     ...
     *     name="eccube_payment_lite42_mypage_regular_resume",
     *     requirements={"id" = "\d+"}
     * )
     * @Template("@EccubePaymentLite42/default/Mypage/regular_resume.twig")
     */
