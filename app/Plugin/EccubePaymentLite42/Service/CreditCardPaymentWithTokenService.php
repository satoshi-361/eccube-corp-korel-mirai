    ...
    public function handle(string $token, string $stCode, $dispatcher, Order $Order)
    {
        ...
        if ($results['result'] === $this->eccubeConfig['gmo_epsilon']['receive_parameters']['result']['3ds']) {
            ...
            $content = $this->twig->render('@EccubePaymentLite42/default/Shopping/transition_3ds_screen.twig', [
                ...
                'PaReq' => $results['pareq'],
                'TermUrl' => $this->container->get('router')->generate('eccube_payment_lite42_reception_3ds', [], UrlGeneratorInterface::ABSOLUTE_URL),
        ...
        if ($results['result'] === $this->eccubeConfig['gmo_epsilon']['receive_parameters']['result']['3ds2']) {
            ...
            $content = $this->twig->render('@EccubePaymentLite42/default/Shopping/transition_3ds2_screen.twig', [
                ...
                'TermUrl' => $this->container->get('router')->generate('eccube_payment_lite42_reception_3ds2', [], UrlGeneratorInterface::ABSOLUTE_URL),
                'MD' => $Order->getPreOrderId(),
                'PaReq' => $results['pareq'],
            ]);
            ...
            logs('gmo_epsilon')->info('Parameter sent 3DS 2.0 処理（カード会社に接続必要） (TermUrl):  = '.$this->container->get('router')->generate('eccube_payment_lite42_reception_3ds2', [], UrlGeneratorInterface::ABSOLUTE_URL));
